...
class Handler:
    ...
    ##返回方法名subsutitution #  name 和 match http://www.yjs001.cn/program/python/22213625267404415054.html
    #pprint(vars(your_object)) self <__main__.Handler instance at 0x7f3283591f80>
    def sub(self,name):
        #print self
        #print "name:"+name #by evan name:emphasis
        def substitution(match):  #here 201808
            #print match  #  <_sre.SRE_Match object at 0x7ff3db9030a8>  # by evan 这是不是str 不能用 print "match"+match
            ...
            #print  "name2:"+name # name2:emphasis
...
20170818 am base pass the code
